...
assert_count 56 "$ref_count" "參考資料筆數"
...
echo "✅ weekly-tech-report-022 驗證通過（正式來源 56、淘汰 76、分類 12、引用 ref-1..56 一致）"
