...
**AI** 技術正快速滲透到室內設計領域，過去需要專業設計師花費大量時間製作的渲染圖，現在透過 **Decoratly**、**Decor8 AI** 等工具，使用者只需上傳一張房間照片，選擇風格，30 秒內就能生成極度逼真的設計方案 [[36]](#ref-36)。這不僅大幅降低了專業設計的門檻，也讓一般消費者能更直觀地參與設計過程。在更廣泛的房地產科技（**PropTech**）領域，技術正在協助包含屋主、買家、租客在內的各方市場參與者提升效率 [[35]](#ref-35)。從線上看房、數位化簽約到智慧建築管理，**PropTech** 的應用正全面重塑房地產的交易與管理流程，使其更加透明、便利。香港政府也提出透過試點計畫、稅收激勵等方式，推動 AI 設施管理與模組化建築等房地產科技的發展 [[46]](#ref-46)。
