...
**OpenAI** 首席產品長 Kevin Weil 揭示，**GPT-5** 的開發成本相較於 **GPT-4** 降低了近百倍，這使得 **OpenAI** 得以採取「反向付費牆」策略，逐步將付費功能轉為免費，致力於讓 **AI** 技術觸及更廣泛的群體 [[1]](#ref-1)。此策略不僅體現在價格上，更展現在對特定市場的重視，例如專為印## <a id="亮點"></a>亮點
