...
| ------------ | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | --------------------------------------- |
| **基本方案** | Pro: $17-20/月 [[5]](#ref-5) | 免費使用 [[2]](#ref-2) 免費額度[參考](https://lazyjerry.github.io/Topics/cli-ai-tools-comparison/gemini-cli-model-quota-analysis-report) | Pro: $20/月 (含 $20 API 額度) [[6]](#ref-6)      | ChatGPT Plus: $20/月 [[4]](#ref-4)      |
