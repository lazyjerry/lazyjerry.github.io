...
```text
依 `tech-report-research` skill 執行本期科技服務資訊週記任務，完整遵循 skill 規格、研究工作流、驗證與交付要求。
```
...
- 僅使用 2026-06-13 至 2026-06-27 內發布，且日期可確認的來源。
...
- 搜尋時間範圍是否正確，是否全部落在 2026-06-13 至 2026-06-27。
- 資料來源是否正確，包含網址、來源網站名稱、發布日期與引用對應。
- 內文引用編號是否與參考資料表編號一致。
- 錯誤來源或整理內容是否已修正。
- `report.md`、`source.md`、`task_plan.md`、`notes.md` 完成後需複製到 `tech/2026-06-27/`，且 `notes.md` 另存為 `note.md`、正式參考資料另存為 `references.md`。