...
依 repo 內建研究流程建立 2026-08-08「科技服務資訊週記」，整理今天起往前 15 天內的科技資訊，使用繁體中文與台灣用語，完成後交付至 tech/2026-08-08/。
```
...
- 標題：`2026-08-08 科技服務資訊週記`
- Meta：`作者：Claude Code、GitHub Copilot　報告日期：2026-08-08`
...
- 僅使用 2026-07-24 至 2026-08-08 發布的資料。
...
- 正式來源權重足夠，且日期位於 2026-07-24 至 2026-08-08。
- 網址、來源網站名稱、發布日期、內容主張與引用對應正確。
- 內文引用編號、HTML 錨點與參考資料表編號一致。
- 錯誤來源或整理內容已修正；research 任務資料夾與 `tech/2026-08-08/` 交付副本一致。
...
| `docs/tech-report-research/knowledge/date-citation-rules.md` | 日期判定、`*未知時間`、引用編號與錨點格式 |
| `docs/tech-report-research/knowledge/report-format.md` | 四段式結構、Markdown 規範與完成檢查 |
| `docs/tech-report-research/knowledge/fetch-gotchas.md` | iThome 403、趨勢型文章落窗外的處理方式 |
